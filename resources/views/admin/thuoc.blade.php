 ...
 <tbody>
  ...
  <tr><td>{{$row['MaThuoc']}}</td>
    ...
    <td>
      <table>
        <tr><td>
         <button type="button" class="btn btn-danger" id="{{$row['MaThuoc']}}" onclick="ConfirmDelete(this.id)"  style="margin-top: -15px;" ><i class="fa fa-remove " style="font-size:20px"></i> </button>
       </td></tr><tr>
        <td>
          <button type="button" style="margin-top: -15px;margin-right: 15px;" id="{{$row['MaThuoc']}}" class="btn btn-primary" onclick="ajax_modal(this.id)">
